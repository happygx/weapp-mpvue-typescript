 ...
 * @LastEditTime: 2021-03-17 14:24:06
 * @LastEditors: happy
 */
import './hmac.js';
import './sha1.js';
...
const clint = {
  ...
  accessKeySecret: '',
  stsToken: '',
  timeout: 87600 // 这个是上传文件时Policy的失效时
};
...
export const uploadFile = (
  ...
  wx.uploadFile({
    ...
    success(res) {
      ...
      typeof options.successCallback === 'function' && options.successCallback(res);
    },
    fail(err) {
...
const getSignature = (policyBase64: any) => {
