<template>
  <div class="tableCom-wrap">
    <van-popup :show="popupShow" @close="popupShow = false" custom-class="popup">
      <p v-for="(operate, i) in operates" :key="i" @click="popupOperate(operate)">
        {{ operate.name }}
      </p>
    </van-popup>
    <van-cell-group>
            ...
            <div style="width: 100%;">
              <div @click="item.click">
                <div class="title">
                  <van-icon
                    name="star"
                    v-if="item.concern !== undefined"
                    :color="item.concern ? '#39b54a' : '#515151'"
                    class="mr5"
                  />
                  ...
                  <i
                    class="iconfont icon-opreate f12"
                    style="margin-left: auto;"
                    v-if="item.operates !== undefined && item.operates.length > 0"
                  ></i>
                </div>
